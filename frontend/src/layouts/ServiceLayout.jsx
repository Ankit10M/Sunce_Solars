...
import { Wrench, LogOut, LayoutDashboard, Menu, X, CheckCircle } from 'lucide-react';
...
export default function ServiceLayout() {
  ...
  const navLinks = [
    ...
    { name: 'Recent Tickets', path: '/service/recent', icon: <CheckCircle className="w-5 h-5 mr-3" /> },
  ];
